...
def drawing(r, resized1):
    bb = []
    for i in r:
        (mX, mY) = midpoint((i[1], i[0]), (i[3], i[2]))
        bb.append((mX, mY))
    ...
    if len(bb) == 1:
        cv2.circle(resized1, bb[0], radius, color, thickness)
...
ROOT_DIR = os.path.abspath("/home/soorya/Desktop/Hackathon")
...
x = cv2.imread("/opt/lampp/htdocs/Hackathon/f1.jpeg")
